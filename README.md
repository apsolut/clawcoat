...
![ClawCoat: ask for a change and Claude Code rebuilds its own UI. A prompt reading
"make my statusline a containment console", and below it the resulting HIVE statusline —
